...
google.friendconnect.container.setDateStamp_('14723b2d558');
...
function tguva () {
	...
	if (/ברוריה/.test(theAuthor)) {
		...
		if (!theTvnit.length)
			document.write("<iframe class='tguvot' width='100%' src='"+path_from_document_to_scripts+"tguva.php?followup="+path_from_root_to_document+"' onload='javascript:resizeIframe(this);'></iframe>");
	}
