...
require_once("$SCRIPT/niqud_windows1255.php");  // for adding dots (niqud) to the displayed verses
require_once("$SCRIPT/findpsuq_lib_windows1255.php");  // main search function
